...
def process_code_translations(project_id, project_name, project_folder, source_language, target_language, force=False):
    repository = CrowdInRepository(None, None, source_language, project_id, project_name, None, project_folder, False, False)
...
def check_pre_translations(project_id, project_name, project_folder, source_language, target_language, force=False):
    ...
    for file_name, file_metadata in file_info.items():
        api_path = '/projects/%s/languages/%s/translations' % (repository.project_id, target_language)
